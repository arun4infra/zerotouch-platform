...
data:
  ...
  # Enable Gateway API support in Cilium
  enable-gateway-api: "true"
  gateway-api-secrets-namespace: "kube-system"
  
  # Enable kube-proxy replacement (required for Gateway API)
  kube-proxy-replacement: "true"
  
  # Enable L7 proxy for Gateway API functionality
  enable-l7-proxy: "true"
  
  # Enable external Envoy proxy for Gateway API
...
- apiGroups:
  ...
  - update
  - patch
# Secrets access for Gateway API TLS
- apiGroups:
  - ""
  resources:
  - secrets
...
spec:
  ...
  - additionalPrinterColumns:
    ...
    subresources: {}
---
# CiliumClusterwideEnvoyConfig CRD - Required for Gateway API
apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
metadata:
  annotations:
